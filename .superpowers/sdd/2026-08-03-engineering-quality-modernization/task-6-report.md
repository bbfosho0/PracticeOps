...
- Converted generated `ApiException` problem details back to the existing `HttpErrorResponse.error.detail` shape while propagating non-API transport errors unchanged.
...
- `npm --prefix frontend run test` — passed, 108/108.
